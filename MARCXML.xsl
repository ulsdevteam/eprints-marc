...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:e="http://eprints.org/ep2/data/2.0" xmlns:exsl="http://exslt.org/common" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:date="http://exslt.org/dates-and-times" exclude-result-prefixes="xsi xsl e exsl date">
